...
.checkmove
	...
	ld bc, .nextmove ; return here from the array function
	push bc

	push de ; indirectly jump to de
	ret
...
; enemy's Special Defense level is lower than +2, and the move is of a special type.
	cp $9
	ret nc
