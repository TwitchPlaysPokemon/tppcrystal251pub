	...
	const ENGINE_51 ;bug catching done today
	...
	const ENGINE_DAILY_EGG
	const ENGINE_DAILY_FOSSIL
	const ENGINE_EARLY_GAME_KANTO
	const ENGINE_MILITARY_MODE_ON
