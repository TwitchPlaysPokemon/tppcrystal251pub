...
.asm_e9b0
	...
	ld a, [wc64e]
	and a
	jr nz, .asm_e9f5 ; You caught the Pokemon!
	ld a, [Buffer2]
	cp $1
	ld hl, UnknownText_0xedb5 ; No shakes
	jp z, .asm_ebdc
	cp $2
	ld hl, UnknownText_0xedba ; One shake
	jp z, .asm_ebdc
	cp $3
	ld hl, UnknownText_0xedbf ; Two shakes
	jp z, .asm_ebdc
	cp $4
	ld hl, UnknownText_0xedc4 ; Three shakes
	jp z, .asm_ebdc
.asm_e9f5
