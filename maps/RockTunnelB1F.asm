...
RockTunnelB1F_MapEventHeader: ; 0x74412
	...
	; people-events
	db 3
	person_event SPRITE_POKE_BALL, 29, 11, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x74409, EVENT_ITEM_ROCKTUNNELB1F_IRON
	person_event SPRITE_POKE_BALL, 21, 10, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x7440b, EVENT_ITEM_ROCKTUNNELB1F_PP_UP
	person_event SPRITE_POKE_BALL, 6, 19, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x7440d, EVENT_ITEM_ROCKTUNNELB1F_REVIVE
; 0x74458
