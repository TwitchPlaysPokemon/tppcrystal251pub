...
UnknownScript_0x77093: ; 0x77093
	setevent EVENT_MOON_STONE_IN_MOUNT_MOON_SQUARE
	return
; 0x77097
...
UnknownScript_0x7709a: ; 0x7709a
	...
	disappear $3
	stopfollow
	clearevent EVENT_MOON_STONE_IN_MOUNT_MOON_SQUARE
...
MountMoonSquare_MapEventHeader: ; 0x77158
	...
	; people-events
	db 3
	person_event SPRITE_FAIRY, 10, 10, $6, 0, 0, -1, -1, 0, 0, 0, ObjectEvent, EVENT_CLEFAIRY_IN_MOUNT_MOON_SQUARE
	person_event SPRITE_FAIRY, 10, 11, $6, 0, 0, -1, -1, 0, 0, 0, ObjectEvent, EVENT_CLEFAIRY_IN_MOUNT_MOON_SQUARE
	person_event SPRITE_ROCK, 11, 11, $18, 0, 0, -1, -1, 0, 0, 0, RockScript_0x7711e, EVENT_MOUNT_MOON_SQUARE_MOON_ROCK
; 0x771a6
