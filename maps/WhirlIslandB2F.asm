...
WhirlIslandB2F_MapEventHeader: ; 0x18c4be
	...
	; people-events
	db 3
	person_event SPRITE_POKE_BALL, 15, 14, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c4b8, EVENT_ITEM_WHIRL_ISLAND_B2F_FULL_RESTORE
	person_event SPRITE_POKE_BALL, 8, 10, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c4ba, EVENT_ITEM_WHIRL_ISLAND_B2F_MAX_REVIVE
