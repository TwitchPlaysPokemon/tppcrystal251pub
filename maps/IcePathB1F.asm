...
IcePathB1F_MapEventHeader: ; 0x7e52d
	...
	; people-events
	db 5
	person_event SPRITE_BOULDER, 11, 15, $19, 0, 0, -1, -1, 0, 0, 0, BoulderScript_0x7e50a, EVENT_ORIGINAL_BOULDER_IN_ICE_PATH_1
	person_event SPRITE_BOULDER, 12, 11, $19, 0, 0, -1, -1, 0, 0, 0, BoulderScript_0x7e50a, EVENT_ORIGINAL_BOULDER_IN_ICE_PATH_2
	person_event SPRITE_BOULDER, 13, 12, $19, 0, 0, -1, -1, 0, 0, 0, BoulderScript_0x7e50a, EVENT_ORIGINAL_BOULDER_IN_ICE_PATH_3
	person_event SPRITE_BOULDER, 11, 21, $19, 0, 0, -1, -1, 0, 0, 0, BoulderScript_0x7e50a, EVENT_ORIGINAL_BOULDER_IN_ICE_PATH_4
	person_event SPRITE_POKE_BALL, 39, 9, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x7e50d, EVENT_ITEM_ICEPATHB1F_MAX_POTION
; 0x7e5a1
