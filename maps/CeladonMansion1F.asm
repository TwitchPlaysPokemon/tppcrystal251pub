...
CeladonMansion1F_MapEventHeader: ; 0x714cc
	...
	; people-events
	db 4
	person_event SPRITE_GRANNY, 9, 5, $3, 0, 0, -1, -1, 0, 0, 0, GrannyScript_0x713ef, -1
	person_event SPRITE_GROWLITHE, 10, 6, $16, 0, 0, -1, -1, 0, 0, 0, GrowlitheScript_0x713f2, -1
	person_event SPRITE_CLEFAIRY, 8, 7, $16, 0, 0, -1, -1, 0, 0, 0, ClefairyScript_0x713fc, -1
	person_event SPRITE_GROWLITHE, 8, 8, $16, 0, 2, -1, -1, 8 + PAL_OW_BLUE, 0, 0, GrowlitheScript_0x71406, -1
; 0x7152e
