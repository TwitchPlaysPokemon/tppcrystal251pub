...
IcePath1F_MapEventHeader: ; 0x7e478
	...
	; people-events
	db 3
	person_event SPRITE_POKE_BALL, 11, 35, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x7e472, EVENT_ITEM_ICEPATH1F_HM_WATERFALL
	person_event SPRITE_POKE_BALL, 27, 36, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x7e474, EVENT_ITEM_ICEPATH1F_PP_UP
