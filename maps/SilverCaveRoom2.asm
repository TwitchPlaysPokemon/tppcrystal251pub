...
SilverCaveRoom2_MapEventHeader: ; 0x18c5bb
	...
	; people-events
	db 3
	person_event SPRITE_POKE_BALL, 14, 28, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c5b2, EVENT_ITEM_SILVERCAVEROOM2_CALCIUM
	person_event SPRITE_POKE_BALL, 28, 26, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c5b4, EVENT_ITEM_SILVERCAVEROOM2_ULTRA_BALL
	person_event SPRITE_POKE_BALL, 24, 8, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c5b6, EVENT_ITEM_SILVERCAVEROOM2_PP_UP
; 0x18c601
