...
WhirlIslandB1F_MapEventHeader: ; 0x18c426
	...
	; people-events
	db 6
	person_event SPRITE_POKE_BALL, 17, 11, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c410, EVENT_ITEM_WHIRL_ISLAND_B1F_FULL_RESTORE
	person_event SPRITE_POKE_BALL, 22, 6, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c412, EVENT_ITEM_WHIRL_ISLAND_B1F_CARBOS
	person_event SPRITE_POKE_BALL, 27, 37, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c414, EVENT_ITEM_WHIRL_ISLAND_B1F_CALCIUM
	person_event SPRITE_POKE_BALL, 12, 21, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c416, EVENT_ITEM_WHIRL_ISLAND_B1F_NUGGET
	person_event SPRITE_POKE_BALL, 30, 23, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x18c418, EVENT_ITEM_WHIRL_ISLAND_B1F_ESCAPE_ROPE
