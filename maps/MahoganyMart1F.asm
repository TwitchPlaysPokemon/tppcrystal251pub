...
MahoganyMart1F_MapEventHeader: ; 0x6c5fb
	...
	; people-events
	db 5
	person_event SPRITE_PHARMACIST, 7, 8, $6, 0, 0, -1, -1, 0, 0, 0, PharmacistScript_0x6c367, EVENT_ROCKETS_POPULATE_ROCKET_BASE
	person_event SPRITE_BLACK_BELT, 10, 5, $3, 0, 0, -1, -1, 0, 0, 0, BlackBeltScript_0x6c37b, EVENT_ROCKETS_POPULATE_ROCKET_BASE
	person_event SPRITE_LANCE, 10, 8, $8, 0, 0, -1, -1, 0, 0, 0, ObjectEvent, EVENT_LANCE_IN_MAHOGANY_MART
	person_event SPRITE_DRAGON, 10, 7, $8, 0, 0, -1, -1, 0, 0, 0, ObjectEvent, EVENT_LANCE_IN_MAHOGANY_MART
	person_event SPRITE_GRANNY, 7, 5, $9, 0, 0, -1, -1, 0, 0, 0, GrannyScript_0x6c3ee, EVENT_MAHOGANY_MART_TRUE_OWNERS
; 0x6c651
