; All locations are in WRAM bank 1.
	...
	dwb VisitedSpawns + 3, %00010000 ; mount moon
	...
	dwb DailyFlags + 1, %00000001 ; mt moon square clefairy  ; $58
	dwb DailyFlags + 1, %00000010 ; union cave lapras
	dwb DailyFlags + 1, %00000100 ; goldenrod underground haircut used
	dwb DailyFlags + 1, %00001000 ; goldenrod mall happiness event floor05 person07
	dwb DailyFlags + 1, %00010000 ; tea in blues house
	dwb DailyFlags + 1, %00100000 ; indigo plateau rival fight
	dwb DailyFlags + 1, %01000000
	dwb DailyFlags + 1, %10000000

	dwb DailyFlags + 2, %00000001 ; $60
	dwb DailyFlags + 2, %00000010 ; goldenrod dept store sale is on
	...
	dwb DailyFlags + 2, %00000100 ; dunsparce swarm   ; $a0
