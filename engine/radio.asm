...
.not3
	...
	ld bc, $10 ;16
	call AddNTimes ; hl+ (bc*a). adds 0, 16 or 32 to choose time of day at random
.asm_b87a9
	call Random
	and 7 ;random 0-7
	cp 2
	jr c, .asm_b87a9
		;cp 5 ;more slots mean an increased range
		;jr nc, .asm_b87a9 ;random 2-4
	ld e, a ;increase in slot range to 2-7
	ld d, 0
	add hl, de ;select a slot from 2-7
		;add hl, de ;not needed with new structure
		;inc hl
	ld a, BANK(WildMons1)
...
; b9221
.RandomSongs
	dw MUSIC_PALLET_TOWN
	dw MUSIC_ROUTE_1
	dw MUSIC_VIRIDIAN_CITY
	dw MUSIC_ROUTE_2
	dw MUSIC_ROUTE_3
	dw MUSIC_CERULEAN_CITY
	dw MUSIC_ROUTE_24
	dw MUSIC_VERMILION_CITY
...
WhosThatPkmn_1:
	call StartRadioStation
	ld hl, WhosThatPkmnText1
	ld a, $59
	jp NextRadioLine

WhosThatPkmn_2:
	ld hl, WhosThatPkmnText2
	ld a, $5a
	jp NextRadioLine

WhosThatPkmn_3:
	ld hl, WhosThatPkmnText3
	ld a, $5b
	jp NextRadioLine

WhosThatPkmn_4:
	ld hl, WhosThatPkmnText4
	ld a, $5c
	jp NextRadioLine

WhosThatPkmn_5:
	ld hl, WhosThatPkmnText5
	ld a, $5d
	jp NextRadioLine

WhosThatPkmn_6:
	ld hl, WhosThatPkmnText6
	ld a, $5e
	jp NextRadioLine
...
WhosThatPkmn_8: ; b8aa4 (2e:4aa4)
	call Functionb8ad4
	ld a, $60
	jp PrintRadioLine

WhosThatPkmn_9: ; b8aa4 (2e:4aa4)
	call Functionb8ad4
	ld a, $61
	jp PrintRadioLine

WhosThatPkmn_10: ; b8aa4 (2e:4aa4)
	call Functionb8ad4
	ld a, $62
	jp PrintRadioLine

WhosThatPkmn_11: ; b8aa4 (2e:4aa4)
	call Functionb8ad4
	ld a, $63
	jp PrintRadioLine

WhosThatPkmn_12: ; b8aa4 (2e:4aa4)
	call Functionb8ad4
	ld a, $64
	jp PrintRadioLine

WhosThatPkmn_13: ; b8aa4 (2e:4aa4)
	ld hl, WhosThatPkmnText7
	ld a, $65
	jp NextRadioLine

WhosThatPkmn_14:
	ld hl, WhosThatPkmnText8
	ld a, $66
	jp NextRadioLine
...
WhosThatPkmn_15:
	...
	ld [wd265], a
	call GetPokemonName
	ld hl, WhosThatPkmnText9
	ld a, $5b
	jp NextRadioLine

WhosThatPkmnText1:
	text_jump _WhosThatPkmnText1
	db "@"

WhosThatPkmnText2:
	text_jump _WhosThatPkmnText2
	db "@"

WhosThatPkmnText3:
	text_jump _WhosThatPkmnText3
	db "@"

WhosThatPkmnText4:
	text_jump _WhosThatPkmnText4
	db "@"

WhosThatPkmnText5:
	text_jump _WhosThatPkmnText5
	db "@"

WhosThatPkmnText6:
	text_jump _WhosThatPkmnText6
	db "@"

WhosThatPkmnText7:
	text_jump _WhosThatPkmnText7
	db "@"

WhosThatPkmnText8:
	text_jump _WhosThatPkmnText8
	db "@"

WhosThatPkmnText9:
	text_jump _WhosThatPkmnText9
	db "@"
