...
wBattleTentBattleRoomTrigger::               ds 1 ; d9c1
wVermilionCityTrigger::                      ds 1 ; d9c2
wRocketHideout1Trigger::                     ds 1
wUndergroundWarehouseTrigger::               ds 1
wAzaleaGymTrigger::                          ds 1
wOlivineLighthouse1FTrigger::                ds 1
wCinnabarVolcanoB2FTrigger::                 ds 1
wRocketHideout2Trigger::                     ds 1
